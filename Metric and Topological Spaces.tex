...
\begin{dfnbox}{Regular Space}{regular}
    A topological space $X$ is {\color{red} \textbf{regular}} or {\color{red} \textbf{$T_3$}} if for any $x \in X$ and any closed set $B \in X$ with $x \notin B$, there exists disjoint open sets $U, V \subseteq X$ with $x \in U$ and $B \subseteq V$.
\end{dfnbox}
...
\begin{dfnbox}{Normal Space}{normal}
    A topological space $X$ is {\color{red} \textbf{normal}} or {\color{red} \textbf{$T_4$}} if for any disjoint closed sets $A, B \subseteq X$, there exists disjoint open sets $U, V \subseteq X$ such that $A \subseteq U$ and $B \subseteq V$.
\end{dfnbox}
