...
\begin{thmbox}{Erdos-Ko-Rado Theorem}{ErdosKoRado}
    ...
    \begin{equation*}
        \mathcal{F} \coloneqq \left\{S \in \mathcal{P}([n]) \colon \abs{S} = k \textrm{ and } S \cap T \neq \varnothing \textrm{ for some } T \in \mathcal{P}([n])\right\}
    \end{equation*}
    is such that $\abs{\mathcal{F}} \leq \begin{pmatrix}
        n - 1 \\
        k - 1
    \end{pmatrix}$.
\end{thmbox}
