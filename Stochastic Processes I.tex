...
\begin{equation*}
    ...
    \end{bmatrix}.
\end{equation*}
It is easy to see that $\pi \coloneqq \left(\frac{1}{2}, \frac{1}{2}\right)$ is the only stationary distribution, but if we have initial distribution $\mu \coloneqq \left(\frac{1}{2}, \frac{1}{2}\right)$, the distribution will not converge to $\pi$.
